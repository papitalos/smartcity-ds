 ...
 * @file   Gestor.c
 * @brief  arquivo de manipula��o de dados dos gestores
 * 
 * @author italo
 * @date   March 2023
...
bool RemoverGestor(ListaGestor** lista, ListaGestor* gestorAtual) {
	...
	// Verifica se o gestor atual � nulo
	...
	// Libera a mem�ria do gestor atual
	free(gestorAtual);
...
bool TrocarGestor(ListaGestor* gestor1, ListaGestor* gestor2) {
	...
	// Troca os dados dos gestores usando uma vari�vel auxiliar
