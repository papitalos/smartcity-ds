 ...
 * @file   Localizacao.c
 * @brief  Fun��es para salvar e ler todas as localiza��es existentes no mapa atual
 * 
 * @author italo
 * @date   May 2023
...
bool RemoverLocal(ListaLocal** lista, ListaLocal* localAtual) {
	...
	// Verifica se o local atual � nulo
	...
	// Libera a mem�ria do local atual
	free(localAtual);
...
bool TrocarLocal(ListaLocal* local1, ListaLocal* local2) {
	...
	// Troca os dados dos locais usando uma vari�vel auxiliar
